            ...
            <div className="relative bg-[#0f172a] p-8 md:p-12 border-2 border-amber-600 rounded-lg shadow-2xl">
              ...
              <div className="mb-8 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-black/30 p-6 rounded-lg border border-amber-600/30">
                    <div className="flex items-start gap-3 mb-3">
                      <div className="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center text-lg font-bold flex-shrink-0">1</div>
                  ...
                  <div className="bg-black/30 p-6 rounded-lg border border-amber-600/30">
                    <div className="flex items-start gap-3 mb-3">
                      <div className="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center text-lg font-bold flex-shrink-0">2</div>
                      <h4 className="text-xl font-bold text-amber-100">
                ...
                <div className="bg-amber-900/30 p-6 rounded-lg border border-amber-500/50">
